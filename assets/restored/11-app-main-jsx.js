...
function _Component105({
  ...
  // [jsos-local-terminal-spawn] iframe 加载期显示 loading 层，避免内容区透出壁纸黑屏
      ...
      touchAction: "none"
        ...
        background: aB(e.appId)
          ...
          WebkitBackdropFilter: `blur(${U.blur}px)`
            ...
            }} />}><_Component23 size={12} /></An><Mn side="top">{f("window.close")}</Mn></_Component25></div>}</B.Fragment> : <B.Fragment>{z ? <B.Fragment><iframe ref={Y} src={z} data-window-id={e.id} className="absolute inset-0 w-full h-full border-none bg-background" key={G} onLoad={() => jsSetIframeReady(true)} /><div className="absolute inset-0 z-10" style={{
          ...
          }}><_Component26 app={e.app} statusText={e.statusText} /></div></B.Fragment> : <_Component26 app={e.app} statusText={e.statusText} />}<div style={{
          position: "absolute",
          bottom: 0,
          left: 0,
          right: 0,
